...
INIT {
    ...
    my $vault_url = sprintf '%s/v1/auth/approle/login', $vault_base;
    ...
    $vault_url = sprintf '%s/v1/kv/data/%s', $vault_base, $vault_kv_secret;
